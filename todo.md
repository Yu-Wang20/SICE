...
## Major UX Overhaul (User Feedback Jan 9)

### Navigation Simplification
- [ ] Remove duplicate navigation (top nav + sidebar conflict)
- [ ] Convert top nav to utility toolbar (Search / Theme / Try Demo only)
- [ ] Keep sidebar as primary navigation
- [ ] Remove redundant Atlas/Tools/Trainer/Cases/About from top bar

### Homepage Bento Layout Redesign
- [ ] Replace current hero with Bento grid layout
- [ ] Main card (7-8 cols): "Today's Training" with Start CTA
- [ ] Secondary card (4-5 cols): "Hand Simulator" with Play CTA
- [ ] Row 2: Three tool cards (Analyze a Spot / Ranges / Trainer) with 1-line descriptions
- [ ] Move Research/Atlas to third screen (not first screen)
- [ ] Each card must have clear "what this does" text

### Unified Design System
- [ ] Create global design tokens (colors, shadows, borders, spacing)
- [ ] Unify light/dark theme across all pages
- [ ] Match Hand Simulator's product-style to other pages
- [ ] Consistent card shadows, borders, color semantics

### Input Experience Improvements
- [x] Analyze a Spot: Auto-complete for hand input (AK → AKo/AKs suggestion)
- [x] Add suited/off-suit toggle button instead of text input
- [x] Replace red error messages with actionable correction buttons
- [ ] Ranges: Hover shows Action/Frequency/Explanation
- [ ] Ranges: Selected hand shows "Why" card with rules

### Micro-interactions
- [x] Tool cards: hover border/shadow change + CTA appears
- [x] Tool cards: click scale(0.99) press effect
- [ ] Hand Simulator: clearer selected state for action buttons
- [ ] Recommended Action: skeleton/loading state during calculation
- [ ] Remove "Coming Soon" blocks or implement minimal versions

### Atlas Scroll Narrative
- [ ] H1 with SplitText animation
- [ ] Section fade-up on viewport entry
- [ ] Step Progress indicator (1/5) for reading position
- [ ] Takeaways card at end + Next Step CTA
